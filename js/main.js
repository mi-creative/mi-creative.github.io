    ...
    window.onscroll = function() {
        ...
        if ($(window).width() < 1024) {
            if (prevScrollpos > currentScrollPos) {
                ...
                document.getElementById("nav-top").style.top = "-70px";
            }
...
//------------------------------------------------------------------------
    ...
    $( "#lang_button" ).click(
        ...
        function() {
            $( ".french" ).slideToggle( "slow", function() {
            });
            $( ".english" ).slideToggle( "slow", function() {
            });

            var lang = $("#lang_button").text();
            if (lang == "Français") {
                $( "#lang_button" ).text( "English" );
                sessionStorage.setItem("language", "Français");
            } else {
                $( "#lang_button" ).text( "Français" );
    ...
    function languageInit() {
        if (sessionStorage.getItem("language")) {
            $( "#lang_button" ).text(sessionStorage.getItem("language"));
            ...
            // Ou l'on regle la langue par defaut // Ici, l'anglais
            sessionStorage.setItem("language", "English");
            $(".french").hide();
        }
    }

...
var DragControls = function ( _objects, _camera, _domElement ) {
    ...
    function onMouseMove( event ) {
        ...
        if ( _intersections.length > 0 ) {
            ...
            Plane.setFromNormalAndCoplanarPoint( _camera.getWorldDirection( Plane.normal ), _worldPosition.setFromMatrixPosition( object.matrixWorld ) );
    ...
    function onTouchStart( event ) {
        ...
        if ( _intersections.length > 0 ) {
            ...
            Plane.setFromNormalAndCoplanarPoint( _camera.getWorldDirection( Plane.normal ), _worldPosition.setFromMatrixPosition( _selected.matrixWorld ) );

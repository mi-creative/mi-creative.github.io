...
document.getElementById("header-main-menu").innerHTML =
    ...
    '<button id="lang_button">Français</button>'+
...
document.getElementById("header-main-text").innerHTML =
    ...
    '<br>'+
    '<!--'+
    '<a class="socail-text" href="#">TW.</a>'+
    '<a class="socail-text" href="#">FB.</a>'+
    '<a class="socail-text" href="#">IN.</a>'+
    '<a class="socail-text" href="#">BE.</a>'+
    '-->'
